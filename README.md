...
The project uses `YYYY.MM.DD.counter` versioning. The first three components identify the date and the final component is the daily release counter. The current release, `2026.08.02.4`, is the fourth release on August 2, 2026. See [CHANGELOG.md](CHANGELOG.md) for release history.
